    ...
    func argumentsverify(forDisplay: Bool) -> [String]? {
        if let config {
            ...
            case SharedReference.shared.synchronize:
                rsyncparameterssynchronize.argumentsforsynchronize(forDisplay: forDisplay, verify: true, dryrun: true)
            case SharedReference.shared.snapshot:
                rsyncparameterssynchronize.argumentsforsynchronizesnapshot(forDisplay: forDisplay, verify: true, dryrun: true)
            case SharedReference.shared.syncremote:
                rsyncparameterssynchronize.argumentsforsynchronizeremote(forDisplay: forDisplay, verify: true, dryrun: true)
            default:
                break
            }
